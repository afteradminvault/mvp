...
import type { AdminProvider } from "@/domain/admin-providers/ports";
  ...
  function handleCreate(event: FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      const response = await fetch("/api/admin/providers", {
        ...
        body: JSON.stringify({ name, defaultCategory, websiteUrl: websiteUrl || undefined, notes: notes || undefined }),
      });
